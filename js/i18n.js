...
(function (root) {
  ...
  var strings = {
    en: {
      ...
      recentEmpty: "No saved projects here yet. They are stored per browser & address — run an analysis, or load a saved .json with “Load project…”.",
      recentUnavailable: "Browser storage is unavailable in this context — use “Save project” to export a .json file instead.",
      recentOpen: "Open",
      recentDelete: "Delete",
    ...
    zh: {
      ...
      recentTitle: "已保存的项目",
      recentEmpty: "这里还没有项目。项目按浏览器与访问地址分别保存——上传分析即可自动保存，或用“载入项目…”打开已保存的 .json。",
      recentUnavailable: "当前环境无法使用浏览器本地存储——请改用“保存项目”导出 .json 文件。",
      recentOpen: "打开",
      recentDelete: "删除",
